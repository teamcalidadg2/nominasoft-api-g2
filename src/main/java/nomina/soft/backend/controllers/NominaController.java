...
public class NominaController {
    ...
    public ResponseEntity<List<NominaModel>> obtenerNominasPorDescripcion(
    ...
    public ResponseEntity<NominaModel> getNomina(@PathVariable("id") String id)
    ...
    @PostMapping("/generar")
    public ResponseEntity<List<BoletaDePagoModel>> generate(@RequestBody NominaDto nominaDto)
    ...
    public ResponseEntity<List<BoletaDePagoModel>> generateByForm(
        ...
        List<BoletaDePagoModel> listaBoletasDePago = nominaService.generarNomina(fecha, descripcion, idPeriodoNomina);
        return new ResponseEntity<>(listaBoletasDePago, OK);
    }

    @PostMapping("/guardar")
    public ResponseEntity<List<BoletaDePagoModel>> save(@RequestBody NominaDto nominaDto)
    ...
    public ResponseEntity<List<BoletaDePagoModel>> saveByForm(
            @RequestParam("fecha") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) Date fecha,
            @RequestParam("descripcion") String descripcion, @RequestParam("idPeriodoNomina") String idPeriodoNomina)
            throws PeriodoNominaNotFoundException, ContratoNotFoundException, EmpleadoNotFoundException,
            ContratoNotValidException, NominaNotValidException, EmpleadoNotValidException {
        List<BoletaDePagoModel> listaBoletasDePago = nominaService.guardarNomina(fecha, descripcion, idPeriodoNomina);
        return new ResponseEntity<>(listaBoletasDePago, OK);
    }
