...
public class AfpImplConstant {
    ...
    public static final String NO_AFP_FOUND_BY_DESCUENTO = "No se encontró ninguna categoría AFP con porcentaje de descuento: ";
    public static final String FOUND_AFP_BY_DESCUENTO = "Se encontró una categoría AFP con porcentaje de descuento: ";
