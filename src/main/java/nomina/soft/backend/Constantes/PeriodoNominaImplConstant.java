...
public class PeriodoNominaImplConstant {
    ...
    public static final String PERIODO_NOMINA_ELIMINADO = "El periodo de nómina indicado ha sido eliminado.";
	public static final String FECHAS_NO_VALIDAS = "La fecha fin del periodo de nómina debe ser mayor en 15 días y no mayor a 30 días a su fecha de inicio.";
