...
import static nomina.soft.backend.Constantes.AfpImplConstant.*;

@Controller
@RequestMapping("/afp")
public class Controlador_Afp {

    private Servicio_Afp servicioAfp;

    @Autowired
    public Controlador_Afp(Servicio_Afp servicioAfp) {
        super();
    ...
    @PostMapping("/guardar")
    public ResponseEntity<Afp> crearNuevaAfp(@RequestBody DTO_Afp dtoAfp)
