...
@Service
@Transactional
public class Impl_Servicio_Contrato implements Servicio_Contrato {

	private DAO_Contrato respositorioContrato;
	private DAO_Empleado repositorioEmpleado;
	private DAO_Afp repositorioAfp;
	private DAO_IncidenciaLaboral repositorioIncidenciaLaboral;
	private DAO_PeriodoNomina repositoPeriodoNomina;
	public static final String TIMEZONE = "America/Lima";

	@Autowired
	public Impl_Servicio_Contrato(DAO_Contrato respositorioContrato, DAO_Empleado repositorioEmpleado,
			DAO_Afp repositorioAfp, DAO_IncidenciaLaboral repositorioIncidenciaLaboral,
			DAO_PeriodoNomina repositoPeriodoNomina) {
		super();
	...
	@Override
	public Contrato guardarNuevoContrato(DTO_Contrato dtoContrato)
	...
	private boolean validarDtoContrato(DTO_Contrato dtoContrato) throws ContratoNotValidException {
	...
	private Contrato obtenerContratoValido(String idContrato)
			throws NumberFormatException, ContratoNotValidException, ContratoNotFoundException {
		Contrato contratoEncontrado = new Contrato();
		if (contratoEncontrado.identificadorValido(idContrato)) {
			contratoEncontrado = this.respositorioContrato.findByIdContrato(Long.parseLong(idContrato));
			if (contratoEncontrado != null)
				return contratoEncontrado;
			else
